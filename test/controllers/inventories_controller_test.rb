...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { Name: @inventory.Name, Serial: @inventory.Serial, Value: @inventory.Value } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { Name: @inventory.Name, Serial: @inventory.Serial, Value: @inventory.Value } }
